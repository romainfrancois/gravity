...
This example is adapted from @WoelwerBressleinBurgard2018 and it's included here to show how the functions withing this package simplify some tasks that otherwise would take some coding time.
...
Since v.0.8.0 the package returns lm or glm objects instead of summaries. Doing that allows to use our functions in conjunction with broom or other packages, for example:
